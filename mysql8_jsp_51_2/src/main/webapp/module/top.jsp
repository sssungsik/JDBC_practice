...
<a href="#">04상품테이블만검색</a>
<a href="<%= request.getContextPath() %>/mgsearch/mg_search_list1.jsp">05회원과상품join검색1(날짜)</a>
<a href="<%= request.getContextPath() %>/mgsearch/mg_search_list2.jsp">판매자 이름으로 검색</a>	<br/><br/>
<%
	}
%>
	<!-- 1-2 로그인 후 화면 시작 -->
